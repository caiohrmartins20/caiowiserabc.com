...
function initCoverFlowCarousel() {
    ...
    const testimonials = [
        ...
        { name: "Gilberto", role: "Empresário - São Paulo", text: "Caio, parabéns pelo trabalho e resultados obtidos. Estou muito satisfeito pela assessoria e atendimento diário." },
        { name: "Renata", role: "Empresária e aposentada - São Manuel", text: "Conheci o Caio através de meu filho... apesar de ser muito jovem demonstra muito conhecimento na área, me deixou bastante tranquila. Estou muito satisfeita principalmente com a atenção e o cuidado." },
        { name: "Márcio", role: "Empresário - São Paulo", text: "Como cliente do Caio e da Wiser, super indico essa modalidade de ter alguém atuando comigo e para mim no acompanhamento de meus investimentos. O poder de decisão fica mais próximo das atualizações do mercado." },
        { name: "Cliente", role: "Rio de Janeiro", text: "Desde o início do nosso contato, Caio tem se mostrado um profissional atencioso, proativo e sempre disposto a esclarecer dúvidas com clareza e cordialidade... tenho tido uma boa impressão de sua postura e dedicação." },
        { name: "Analuiza", role: "Cliente", text: "Sua dedicação, profissionalismo e disponibilidade me transmitem muita confiança nas decisões financeiras. Muito obrigada!" },
        { name: "Raphael", role: "Casal de empresários - São Paulo", text: "Atendimento de excelência, com clareza, agilidade e total comprometimento. Um suporte indispensável nas minhas decisões financeiras." },
        { name: "Austin e Kátia", role: "Administrador de bens - São Paulo", text: "Podemos recomendar o Caio e seus colegas de forma plena pela assessoria financeira profissional e pelo suporte que sempre nos ofereceram." },
        { name: "Fabiana Guimarães", role: "Empresária - São Paulo", text: "Venho expressar minha satisfação em ter o Caio Martins como assessor. O Caio é um profissional muito atencioso e prestativo, com um atendimento excelente, oferece soluções personalizadas e nos auxilia de maneira clara e eficiente." },
        { name: "Matheus Guimarães", role: "Empresário - São Paulo", text: "Trabalho com o Caio já faz alguns anos e gosto muito do jeito que ele conduz tudo. O trabalho dele é sempre bem pensado e feito de acordo com o meu perfil de investidor. É alguém em quem confio de verdade." },
        ...
        { name: "Emerson Brandão", role: "Empresário - São Caetano do Sul", text: "Antes de iniciar o acompanhamento com Caio Martins, minhas finanças pareciam um quebra-cabeça complexo. Desde o primeiro contato, senti uma confiança imediata. Hoje, sinto uma segurança incomparável em relação ao meu dinheiro e ao meu futuro." }
    ];
