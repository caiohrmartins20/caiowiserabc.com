...
function initCoverFlowCarousel() {
    ...
    const testimonials = [
        ...
        { name: "Raphael", role: "Casal de empresários", text: "Atendimento de excelência, com clareza, agilidade e total comprometimento. Um suporte indispensável nas minhas decisões financeiras." },
